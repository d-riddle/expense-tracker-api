...
import in.ankitapps.expensetrackerapi.entity.ErrorObject;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorObject> handleResourceNotFoundException(ResourceNotFoundException ex, WebRequest request){
        ...
        errorObject.setTimesstamp(new Date());
    ...
    public ResponseEntity<Object> handleItemsAlreadyExistsException(ItemsAlreadyExistsException ex,WebRequest webRequest){
        ErrorObject errorObject=new ErrorObject();
